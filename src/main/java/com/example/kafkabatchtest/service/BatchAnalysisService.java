...
public class BatchAnalysisService {
    ...
    private final List<BatchAnalysisResult> results = Collections.synchronizedList(new ArrayList<>());
    ...
    public BatchStatistics getStatistics() {
        ...
        var batchSizeDistribution = allResults.stream()
                .collect(Collectors.groupingBy(BatchAnalysisResult::getMessageCount, Collectors.counting()));
